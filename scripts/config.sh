...
heroku config:set \
  ...
  AWS_ACCESS_KEY_ID=$AWS_THOMASJTHOREN_ACCESS_KEY_ID \
  AWS_SECRET_ACCESS_KEY=$AWS_THOMASJTHOREN_SECRET_ACCESS_KEY \
  AWS_DEFAULT_REGION=$AWS_THOMASJTHOREN_DEFAULT_REGION \
